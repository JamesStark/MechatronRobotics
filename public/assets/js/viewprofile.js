	...
	$.ajax({
		...
		success: function(data) {
			$.each(data.data, function(i, item) {
				...
				$('#fname').text(item.father_name);
				$('#mname').val(item.mother_name);
				$('#mname').text(item.mother_name);
				$('#occp').val(item.mf_occupation);
				$('#occp').text(item.mf_occupation);
				$('#add1').val(item.st_addr1);
				$('#add1').text(item.st_addr1);
				$('#add2').val(item.st_addr2);
				$('#add2').text(item.st_addr2);
				$('#add3').val(item.st_addr3);
				$('#add3').text(item.st_addr3);
				$('#city').val(item.city);
				$('#city').text(item.city);
